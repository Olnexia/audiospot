            ...
            <form action="${pageContext.servletContext.contextPath}/controller?command=submitAlbum" method="post">
                ...
                <label>
                    <input type="text" name="title" title="<fmt:message key="artistTitleDesc"/>"
                           pattern="[A-Za-z0-9',. ]{1,32}" required placeholder="<fmt:message key="title"/>"/>
                </label title="<fmt:message key="artistTitleDesc"/>">
                <label>
                    <input type="text" name="release_year" title="<fmt:message key="yearDesc"/>" pattern="[0-9]{4}"
                ...
                <div class="buttons">
                    ...
                    <label title="<fmt:message key="cancel"/>">
                        <a class="button"
                           href="${pageContext.servletContext.contextPath}/controller?command=showAlbums"><fmt:message
                                key="cancel"/></a>
                    </label>
                </div>
            </form>
