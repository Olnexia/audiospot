...
<fmt:bundle basename="pagecontent" prefix="clients.">
    ...
    <head>
        ...
        <script>
            <jsp:include page="/js/changeClientStatus.js"/>
        </script>
                ...
                <tr>
                    ...
                    <td class="manage-buttons">
                        ...
                        <c:if test="${client.active eq true}">
                            <a class="negative-button" onclick="changeClientStatus(${client.id})">
                               <%--href="${pageContext.servletContext.contextPath}/controller?command=changeClientStatus&userId=${client.id}">--%>
                                <fmt:message key="block"/></a>
                        </c:if>
                        <c:if test="${client.active eq false}">
                            <a class="positive-button"
                               onclick="changeClientStatus(${client.id})">
                                <fmt:message key="unblock"/></a>
                        </c:if>
                    </td>
                </tr>
            </ph:pagination>
