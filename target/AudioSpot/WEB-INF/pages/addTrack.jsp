    ...
    <div class="content">
        <div class="form-style">
            ...
            <form action="${pageContext.servletContext.contextPath}/controller?command=submitTrack" method="post">
                <label>
                    <input type="text" name="artist" title="<fmt:message key="artistTitleDesc"/>"
                           pattern="[A-Za-z0-9,.' ]{1,32}" placeholder="<fmt:message key="artist"/>" required/>
                </label>
                <label>
                    <input type="text" name="title" title="<fmt:message key="artistTitleDesc"/>"
                           pattern="['A-Za-z0-9,.' ]{1,32}" placeholder="<fmt:message key="audioTitle"/>" required/>
                </label>
                ...
                <label>
                    <input type="text" name="price" title="<fmt:message key="priceDesc"/>"
                           pattern="^[0-9]+(\.[0-9]{2})?$" placeholder="<fmt:message key="price"/>" required/>
                </label>
                ...
                <div class="buttons">
                    ...
                    <label title="<fmt:message key="cancel"/>">
                        <a class="button"
                           href="${pageContext.servletContext.contextPath}/controller?command=showTracks">
