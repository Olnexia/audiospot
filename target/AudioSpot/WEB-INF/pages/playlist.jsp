...
<fmt:bundle basename="pagecontent" prefix="playlist.">
    ...
    <head>
        ...
        <style>
            <jsp:include page="/css/playlist.css"/>
        </style>
        <style>
            <jsp:include page="/css/icon-button.css"/>
        </style>
        <script type="text/javascript">
            <jsp:include page="/js/modal/comment.js"/>
        </script>
    </head>
    <body>
    <div class="content">
        ...
        <c:if test="${fn:length(tracks)ne 0}">
            ...
            <div id="comment" class="modal">
                <div class="form-style">
                    ...
                    <form name="comment"
                          action="${pageContext.servletContext.contextPath}/controller?command=submitComment"
                          method="post">
                        <label title="comment">
                            <textarea name="text" cols="30" rows="5"
                                      placeholder="<fmt:message key="commentPlaceholder"/>"></textarea>
                        </label>
