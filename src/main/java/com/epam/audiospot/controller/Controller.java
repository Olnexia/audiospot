...
/**
 * The main class of the application that is responsible for processing all GET and POST
 * http requests from clients by {@code doGet} and {@code doPost} methods respectively
 */
