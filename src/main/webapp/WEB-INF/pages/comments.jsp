...
<fmt:bundle basename="pagecontent" prefix="comments.">
    ...
    <head>
        ...
        <style>
            <jsp:include page="/css/comments.css"/>
        </style>
        <style>
            ...
            <div class="empty-comments">
                ...
                <c:if test="${sessionScope.user.role.value eq 'client'}">
                    ...
                    <div class="icon-button "
                         onclick="window.location='${pageContext.servletContext.contextPath}/controller?command=orderTrack&trackId=${requestScope.trackId}'">
